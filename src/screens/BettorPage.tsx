          ...
          <div className="flex justify-between items-center mb-[-8px]">
            ...
            <div className="flex items-center gap-2">
              <Link
                ...
                className="w-8 h-8 rounded-full bg-surface-container border border-outline-variant flex items-center justify-center text-on-surface hover:text-primary transition-all"
